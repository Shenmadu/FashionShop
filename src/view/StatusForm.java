...
public class StatusForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        statusButton.setBackground(new java.awt.Color(51, 153, 255));
        ...
        statusButton.setPreferredSize(new java.awt.Dimension(135, 32));
        ...
        if (orders == null) {
            ...
            if (orders.getOrderStatus() != 2) {
                ...
                switch (orders.getOrderStatus()) {
                    case 0:
                        String[] options = {"Delevering", "Deleverd"};
                        int selection = JOptionPane.showOptionDialog(this, "Please select the status:", "Status", 0, 3, null, options, options[0]);
                        if (selection == 0) {
                    ...
                    case 1:
                        String[] options2 = {"Deleverd"};
                        int selection2 = JOptionPane.showOptionDialog(this, "Please select the status:", "Status", 0, 3, null, options2, options2[0]);
                        if (selection2 == 0) {
                            orders.setOrderStatus(2);
                            JOptionPane.showMessageDialog(this, "Status Updated..!");
                            dispose();
