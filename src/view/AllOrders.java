...
public class AllOrders extends javax.swing.JFrame {
    ...
    public AllOrders() {
        ...
        DefaultTableCellRenderer headerRenderer = (DefaultTableCellRenderer) allOrdersTable.getTableHeader().getDefaultRenderer();
        ...
        allOrdersTable.setRowHeight(50);

        Orders[] orders = OrderController.allorders();
